...
#programs = $(BUILD)/test
objects = $(BUILD)/ReadCrd.o $(BUILD)/ReadGrids.o $(BUILD)/ReadQuaternions.o $(BUILD)/Rotate.o $(BUILD)/QuaternionMultiply.o $(BUILD)/FillLigandGrid.o $(BUILD)/GetMinCoors.o $(BUILD)/GetNonbondedParameters.o $(BUILD)/GetIdxOfAtomsForVdwRadius.o $(BUILD)/GeneConformations.o $(BUILD)/GetMaxCoors.o $(BUILD)/kernel.o $(BUILD)/QuaternionUniformSampling.o $(BUILD)/FilterQuaternions.o $(BUILD)/AddGridForcesToOpenMMSystem.o $(BUILD)/GeneRandomConformations.o $(BUILD)/AddCustomNonbondedForceToOpenMMSystem.o $(BUILD)/RemoveNonbondedForceBetweenMasslessParticles.o $(BUILD)/CalcRMSD.o
